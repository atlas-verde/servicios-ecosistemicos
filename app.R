#
# Dashboard for "Servicios ecosistémicos"
#
...
# Data sources
DSN_CANTONS <- "data/metricas-servicios-ecosistemicos.geojson"
...
COLUMN_TREECOVER_DENSITY <- cantons$dens_arb
COLUMN_WETLANDAREA_AREA <- cantons$sup_humeda

COLUMN_VEGETATION_PERCENTAGE <- cantons$porc_vt
COLUMN_NATURALAREA_PERCENTAGE <- cantons$porc_vn
COLUMN_SEMINATURALAREA_PERCENTAGE <- cantons$porc_vsn

COLUMN_CULTIVATEDLAND_AREA <- cantons$tierrasc_h
COLUMN_CULTIVATEDPASTURES_AREA <- cantons$pastos_ha
COLUMN_SHADECOFFEE_AREA <- cantons$cafe_ha
COLUMN_PERMANENTCROPS_AREA <- cantons$perenne_ha
COLUMN_ANNUALCROPS_AREA <- cantons$anuales_ha
  ...
  output$map_biodiversityhabitat <- renderLeaflet({
    if (input$radiobuttons_indicators_biodiversityhabitat == INDICATOR_TREECOVER_DENSITY) {
      create_map(
        ...
        ~ PALETTE_TREECOVER_DENSITY(dens_arb),
      ...
      create_map(
        ...
        ~ PALETTE_WETLANDAREA_AREA(sup_humeda),
  ...
  output$map_regulating <- renderLeaflet({
    if (input$radiobuttons_indicators_regulating == INDICATOR_VEGETATION_PERCENTAGE) {
      create_map(
        ...
        ~ PALETTE_VEGETATION_PERCENTAGE(porc_vt),
      ...
      create_map(
        ...
        ~ PALETTE_NATURALAREA_PERCENTAGE(porc_vn),
      ...
      create_map(
        ...
        ~ PALETTE_SEMINATURALAREA_PERCENTAGE(porc_vsn),
  ...
  output$map_foodprovisioning <- renderLeaflet({
    if (input$radiobuttons_indicators_foodprovisioning == INDICATOR_CULTIVATEDLAND_AREA) {
      create_map(
        ...
        ~ PALETTE_CULTIVATEDLAND_AREA(tierrasc_h),
      ...
      create_map(
        ...
        ~ PALETTE_CULTIVATEDPASTURES_AREA(pastos_ha),
      ...
      create_map(
        ...
        ~ PALETTE_SHADECOFFEE_AREA(cafe_ha),
      ...
      create_map(
        ...
        ~ PALETTE_PERMANENTCROPS_AREA(perenne_ha),
      ...
      create_map(
        ...
        ~ PALETTE_ANNUALCROPS_AREA(anuales_ha),
